...
export const DEFAULT_LAYOUTS_BY_ROLE: Record<string, DashboardWidgetConfig[]> = {
  SUPER_ADMIN: [
    { id: "1", widgetType: "property_overview", size: "SMALL", order: 1 },
    { id: "2", widgetType: "financial_summary", size: "MEDIUM", order: 2 },
    { id: "3", widgetType: "rent_collection", size: "MEDIUM", order: 3 },
    { id: "4", widgetType: "pending_expenses", size: "MEDIUM", order: 4 },
    { id: "5", widgetType: "maintenance_overview", size: "MEDIUM", order: 5 },
    { id: "6", widgetType: "compliance_alerts", size: "MEDIUM", order: 6 },
    { id: "7", widgetType: "quick_actions", size: "SMALL", order: 7 },
  ...
  PROPERTY_MANAGER: [
    ...
    { id: "2", widgetType: "financial_summary", size: "MEDIUM", order: 2 },
    { id: "3", widgetType: "rent_collection", size: "MEDIUM", order: 3 },
    { id: "4", widgetType: "maintenance_overview", size: "MEDIUM", order: 4 },
    { id: "5", widgetType: "compliance_alerts", size: "MEDIUM", order: 5 },
    { id: "6", widgetType: "quick_actions", size: "SMALL", order: 6 },
