  ...
  const shortTermCards = [
    {
      ...
      icon: RefreshCw,
      href: `/turnovers?propertyId=${propertyId}`,
      path: "turnovers",
    },
    {
      ...
      icon: SprayCan,
      href: `/cleaning?propertyId=${propertyId}`,
      path: "cleaning",
    },
    {
      ...
      icon: LogIn,
      href: `/guest-checkin?propertyId=${propertyId}`,
      path: "guest-checkin",
    },
  ];
  ...
  const ownerOccupiedCards = [
    {
      ...
      icon: Clock,
      href: `/maintenance-schedule?propertyId=${propertyId}`,
    ...
    },
    {
      ...
      icon: Thermometer,
      href: `/appliances?propertyId=${propertyId}`,
      path: "appliances",
    },
    {
